...
--
-- Host: 127.0.0.1
-- Creato il: Mag 12, 2025 alle 09:57
...
INSERT INTO `partite` (`id_partita`, `id_squadra1`, `id_squadra2`, `gol_1`, `gol_2`, `data_partita`, `orario`, `id_torneo`) VALUES
(4, 1, 2, 0, 0, NULL, NULL, 2),
(5, 3, 4, 5, 0, NULL, NULL, 3),
(6, 3, 5, 3, 4, NULL, NULL, 3),
(7, 3, 6, 3, 1, NULL, NULL, 3),
(8, 3, 7, 1, 4, NULL, NULL, 3),
(9, 4, 5, 0, 0, NULL, NULL, 3),
(10, 4, 6, 3, 4, NULL, NULL, 3),
(11, 4, 7, 1, 1, NULL, NULL, 3),
(12, 5, 6, 2, 0, NULL, NULL, 3),
(13, 5, 7, 3, 1, NULL, NULL, 3),
(14, 6, 7, 0, 0, NULL, NULL, 3),
(15, 8, 9, 1, 0, NULL, NULL, 4),
(16, 8, 10, 0, 1, NULL, NULL, 4),
(17, 9, 10, 1, 1, NULL, NULL, 4);
...
INSERT INTO `squadre` (`Id_squadra`, `nome`, `id_torneo`, `id_creatore`) VALUES
(1, 'Real Madrid', 2, 1),
(2, 'Barcellona', 2, 6),
(3, 'Real Madrid', 3, 1),
(4, 'Barcellona', 3, 1),
...
--
ALTER TABLE `campo_torneo`
  MODIFY `id_campo_torneo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `partite`
  MODIFY `id_partita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT per la tabella `recensioni`
--
ALTER TABLE `recensioni`
  MODIFY `Id_recensione` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `squadre`
  MODIFY `Id_squadra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `utente_squadra`
  MODIFY `id_utente_squadra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
